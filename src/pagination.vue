...
export default /*#__PURE__*/ defineComponent({
  ...
  computed: {
    ...
    pages: function () {
      ...
      let pageCount = this.pageCount.autoCount
        ? this.count(this.pageCount.count, this.pageCount.limit)
        : this.pageCount.count;

      if (pageCount <= this.pageRange) {
  ...
  methods: {
    handlePageSelected(selected: any) {
    ...
    nextPage() {
      ...
      if (this.selected >= pageCount) return;
      this.handlePageSelected(this.selected + 1);
    },
    firstPageSelected() {
    ...
    lastPageSelected() {
      ...
      return this.selected === pageCount || pageCount === 0;
    },
    selectFirstPage() {
      if (this.selected <= 1) return;
    ...
    selectLastPage() {
      ...
      if (this.selected >= pageCount) return;
      this.handlePageSelected(pageCount);
    },
